--[[ lua modulefile for ifx 2025.3

NOTENOTENOTE: See below for needed patch!

NOTE: It looks like the Base installer is no longer needed!

This was installed using the intel-oneapi-hpc-toolkit-2025.3.0.381_offline.sh installer:
...
After running `bash intel-oneapi-hpc-toolkit-2025.3.0.381_offline.sh` the GUI came up and
...
patchelf --add-needed libm.so.6 /ford1/share/gmao_SIteam/intel/oneapi/2025/compiler/2025.3/lib/libimf.so
...
local mdir  = pathJoin(mroot,"Compiler/ifx-2025.3")
