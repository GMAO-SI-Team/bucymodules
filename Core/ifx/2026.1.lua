--[[ lua modulefile for ifx 2026.1

NOTENOTENOTE: See below for needed patch!

NOTE: It looks like the Base and HPC toolkits were merged.

This was installed using the intel-oneapi-toolkit-2026.1.0.192_offline.sh installer:
...
After running `bash intel-oneapi-toolkit-2026.1.0.192_offline.sh` the GUI came up and
...
patchelf --add-needed libm.so.6 /ford1/share/gmao_SIteam/intel/oneapi/2026/compiler/2026.1/lib/libimf.so
...
local mdir  = pathJoin(mroot,"Compiler/ifx-2026.1")
