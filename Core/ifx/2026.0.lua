--[[ lua modulefile for ifx 2026.0

NOTENOTENOTE: See below for needed patch!

NOTE: It looks like the Base and HPC toolkits were merged.

This was installed using the intel-oneapi-toolkit-2026.0.0.198_offline.sh installer:
...
After running `bash intel-oneapi-toolkit-2026.0.0.198_offline.sh` the GUI came up and
a custom install was selected. In that I changed the install directory to:

/ford1/share/gmao_SIteam/intel/oneapi/2026
...
patchelf --add-needed libm.so.6 /ford1/share/gmao_SIteam/intel/oneapi/2026/compiler/2026.0/lib/libimf.so
...
local version = "2026.0"
local oneapidir = "/ford1/share/gmao_SIteam/intel/oneapi/2026"
local compilerdir = pathJoin(oneapidir,"compiler",version)
local mkldir = pathJoin(oneapidir,"mkl",version)

-- Setup Modulepath for packages built by this compiler
local mroot = "/ford1/share/gmao_SIteam/lmodulefiles"
local mdir  = pathJoin(mroot,"Compiler/ifx-2026.0")
