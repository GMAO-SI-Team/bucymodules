--[[ lua modulefile for ifx 2025.0

NOTENOTENOTE: See below for needed patch!
  
NOTE: It looks like the Base installer is no longer needed!

This was installed using the intel-oneapi-hpc-toolkit-2025.0.0.825_offline.sh installer.

After running `bash intel-oneapi-hpc-toolkit-2025.0.0.825_offline.sh` the GUI came up and
...
local mdir  = pathJoin(mroot,"Compiler/ifx-2025.0")
