...
This was installed using the intel-oneapi-hpc-toolkit-2025.2.0.575_offline.sh installer:

  wget https://registrationcenter-download.intel.com/akdlm/IRC_NAS/e974de81-57b7-4ac1-b039-0512f8df974e/intel-oneapi-hpc-toolkit-2025.2.0.575_offline.sh

After running `bash intel-oneapi-hpc-toolkit-2025.2.0.575_offline.sh` the GUI came up and
...
patchelf --add-needed libm.so.6 /ford1/share/gmao_SIteam/intel/oneapi/2025/compiler/2025.2/lib/libimf.so
...
local mdir  = pathJoin(mroot,"Compiler/ifx-2025.2")
