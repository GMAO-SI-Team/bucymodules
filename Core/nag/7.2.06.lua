--[[ stub routine for nag
 ...
 Installed as:
  ...
  and copied the URL for the x86 Linux installer.
    ...
    wget https://monet.nag.co.uk/compiler/r72download/npl6a72na_amd64_7201.tgz
    tar -xf npl6a72na_amd64_7201.tgz
 
    cd NAG_Fortran-amd64/
 
  You run INSTALL.sh and pass in:
 
    /ford1/share/gmao_SIteam/nag/7.2.06/bin
...
prepend_path("MANPATH",pathJoin(gccinstalldir,"share/man"))
