...
wget https://ftp.gnu.org/gnu/gcc/gcc-14.4.0/gcc-14.4.0.tar.xz
tar -xf gcc-14.4.0.tar.xz

cd gcc-14.4.0
./contrib/download_prerequisites

mkdir build-gcc-14.4.0 && cd build-gcc-14.4.0
../configure --prefix=/ford1/share/gmao_SIteam/gcc/gcc-14.4.0 \
...
local mdir  = pathJoin(mroot,"Compiler/gcc-14.4.0")
