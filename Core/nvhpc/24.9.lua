...
tar -xf nvhpc_2024_249_Linux_x86_64_cuda_12.6.tar.gz
cd nvhpc_2024_249_Linux_x86_64_cuda_12.6/
./install
...
NVHPC then creates modulesfiles. This one is the nvhpc-nompi/24.9 and was installed via

cp /ford1/share/gmao_SIteam/nvidia/hpc_sdk/modulefiles/nvhpc-nompi/24.9 .
...
local mdir  = pathJoin(mroot,"Compiler/nvhpc-24.9")
