...
NOTE NOTE NOTE This is for the LLVM Flang based NVHPC 26.1.

This modulefile is based on the ones that comes from the NVIDIA install itself.

I got the software from https://partners.nvidia.com/DocumentDetails?siteID=311995
and then downloaded to laptop and transferred to Bucy.

tar -xf nvhpc_2026_261ng_Linux_x86_64.tar.gz
cd nvhpc_2026_261ng_Linux_x86_64
./install
...
NVHPC then creates modulesfiles. This one is the nvhpc-nompi/26.1 and was installed via

cp /ford1/share/gmao_SIteam/nvidia/hpc_sdk/modulefiles/nvhpc-nompi/26.1 .
