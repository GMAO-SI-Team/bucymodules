...
tar -xf nvhpc_2025_255_Linux_x86_64_cuda_12.9.tar.gz
cd nvhpc_2025_255_Linux_x86_64_cuda_12.9/
./install
...
NVHPC then creates modulesfiles. This one is the nvhpc-nompi/25.5 and was installed via

cp /ford1/share/gmao_SIteam/nvidia/hpc_sdk/modulefiles/nvhpc-nompi/25.5 .
...
local mdir  = pathJoin(mroot,"Compiler/nvhpc-25.5")
