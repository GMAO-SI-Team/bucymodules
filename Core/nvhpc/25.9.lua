...
tar -xf nvhpc_2025_259_Linux_x86_64_cuda_13.0.tar.gz
cd nvhpc_2025_259_Linux_x86_64_cuda_13.0/
./install
...
NVHPC then creates modulesfiles. This one is the nvhpc-nompi/25.9 and was installed via

cp /ford1/share/gmao_SIteam/nvidia/hpc_sdk/modulefiles/nvhpc-nompi/25.9 .
...
local mdir  = pathJoin(mroot,"Compiler/nvhpc-25.9")
