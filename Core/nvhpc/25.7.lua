...
tar -xf nvhpc_2025_257_Linux_x86_64_cuda_12.9.tar.gz
cd nvhpc_2025_257_Linux_x86_64_cuda_12.9/
./install
...
NVHPC then creates modulesfiles. This one is the nvhpc-nompi/25.7 and was installed via

cp /ford1/share/gmao_SIteam/nvidia/hpc_sdk/modulefiles/nvhpc-nompi/25.7 .
...
local mdir  = pathJoin(mroot,"Compiler/nvhpc-25.7")
