...
NVHPC then creates modulesfiles. This one is the nvhpc-nompi/25.3 and was installed via

cp /ford1/share/gmao_SIteam/nvidia/hpc_sdk/modulefiles/nvhpc-nompi/25.3 .
...
local mdir  = pathJoin(mroot,"Compiler/nvhpc-25.3")
