...
tar -xf nvhpc_2024_247_Linux_x86_64_cuda_12.5.tar.gz
...
NVHPC then creates modulesfiles. This one is the nvhpc-nompi/24.7 and was installed via

cp /ford1/share/gmao_SIteam/nvidia/hpc_sdk/modulefiles/nvhpc-nompi/24.7 .
...
local mdir  = pathJoin(mroot,"Compiler/nvhpc-24.7")
