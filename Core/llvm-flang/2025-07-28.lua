--[[ lmod for llvm-flang built on 2025-07-28
...
ml gcc/12.1.0
mkdir -p tmp/
TMPDIR=tmp ./build-flang.sh --prefix=/ford1/share/gmao_SIteam --add-date |& tee build.2025-07-28.log

If/when the build fails, you can rebuild with:

TMPDIR=tmp ./build-flang.sh --prefix=/ford1/share/gmao_SIteam --add-date --rebuild |& tee build.2025-07-28.rebuild.log
