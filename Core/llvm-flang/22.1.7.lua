--[[ lmod for llvm-flang 22.1.7 build
...
TMPDIR=/ford1/share/gmao_SIteam/build-llvm-flang/tmp ./build-flang.sh --prefix=/ford1/share/gmao_SIteam --llvm-version=22.1.7 |& tee build.22.1.7.log

If/when the build fails, you can rebuild with:

TMPDIR=/ford1/share/gmao_SIteam/build-llvm-flang/tmp ./build-flang.sh --prefix=/ford1/share/gmao_SIteam --llvm-version=22.1.7 --rebuild |& tee build.22.1.7.rebuild.log
...
NOTE 2: the script automatically appends "llvm-flang" to the prefix and then the --llvm-version=22.1.7 option adds the date to the end of the directory name.
