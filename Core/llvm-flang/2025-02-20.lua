--[[ lmod for llvm-flang built on 2025-02-20
...
ml gcc/12.1.0
mkdir -p tmp/
TMPDIR=tmp ./build-flang-f18.sh --prefix=/ford1/share/gmao_SIteam --add-date |& tee build.2025-02-20.log

If/when the build fails, you can rebuild with:

TMPDIR=tmp ./build-flang-f18.sh --prefix=/ford1/share/gmao_SIteam --add-date --rebuild |& tee build.2025-02-20.rebuild.log
