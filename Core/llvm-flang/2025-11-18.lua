--[[ lmod for llvm-flang built on 2025-11-18
...
NOTE NOTE NOTE: I have had lots of issues on Bucy with the build script on "main". There is a simpler one we are trying on the:
...
TMPDIR=/ford1/share/gmao_SIteam/build-llvm-flang/tmp ./build-flang.sh --prefix=/ford1/share/gmao_SIteam --add-date --use-gold |& tee build.2025-11-18.log

If/when the build fails, you can rebuild with:

TMPDIR=/ford1/share/gmao_SIteam/build-llvm-flang/tmp ./build-flang.sh --prefix=/ford1/share/gmao_SIteam --add-date --use-gold --rebuild |& tee build.2025-11-18.rebuild.log
