...
and I ran
  ...
  ./install_miniconda.bash --python_version 3.12 --miniconda_version 24.1.2-0 --micromamba --prefix /ford1/share/gmao_SIteam/GEOSpyD |& tee install.mini24.1.2-0_2024-04-11.log
