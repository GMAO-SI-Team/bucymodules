...
ml gcc/12.1.0
./install_miniforge.bash --python_version 3.11 --miniforge_version 24.7.1-0 --ffnet-hack --prefix /ford1/share/gmao_SIteam/GEOSpyD |& tee install.mini24.7.1-0.py3.11.2024-09-04.log
