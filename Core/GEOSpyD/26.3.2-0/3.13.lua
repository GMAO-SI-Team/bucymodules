...
ml gcc/12.1.0
./install_miniforge.bash --python_version 3.13 --miniforge_version 26.3.2-0 --ffnet-hack --prefix /ford1/share/gmao_SIteam/GEOSpyD |& tee install.mini26.3.2-0.py3.13.2026-05-11.log
