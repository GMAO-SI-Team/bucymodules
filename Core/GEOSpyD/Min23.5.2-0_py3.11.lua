...
and I ran
  ...
  ./install_miniconda.bash --python_version 3.11 --miniconda_version 23.5.2-0 --micromamba --prefix /ford1/share/gmao_SIteam/GEOSpyD |& tee install.mini23.5.2-0_2023-10-18.log
