...
ml gcc/12.1.0
./install_miniforge.bash --python_version 3.12 --miniforge_version 25.3.1-0 --ffnet-hack --prefix /ford1/share/gmao_SIteam/GEOSpyD |& tee install.mini25.3.1-0.py3.12.2025-10-07.log
