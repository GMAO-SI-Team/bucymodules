...
cmake -B build-llvm-flang-22.1.0 -S . --install-prefix=/ford1/share/gmao_SIteam/OpenBLAS/llvm-flang-22.1.0/0.3.31 |& tee cmake.llvm-flang-22.1.0.log
cmake --build build-llvm-flang-22.1.0 -j8 |& tee build.llvm-flang-22.1.0.log
...
local name = "OpenBLAS"
local compiler = "llvm-flang-22.1.0"
