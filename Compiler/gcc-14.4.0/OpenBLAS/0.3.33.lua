...
cmake -B build-gcc-14.4.0 -S . --install-prefix=/ford1/share/gmao_SIteam/OpenBLAS/gcc-14.4.0/0.3.33 |& tee cmake.gcc-14.4.0.log
cmake --build build-gcc-14.4.0 -j8 |& tee build.gcc-14.4.0.log
cmake --install build-gcc-14.4.0 |& tee install.gcc-14.4.0.log

--]]


local name = "OpenBLAS"
local compiler = "gcc-14.4.0"
