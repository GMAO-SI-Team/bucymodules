...
../configure --disable-wrapper-rpath --disable-wrapper-runpath \
   ...
   --prefix=/ford1/share/gmao_SIteam/MPI/openmpi/5.0.3-GillesNAGPatch/nag-7.2.43 |& tee configure.nag-7.2.43.log

mv config.log config.nag-7.2.43.log
make -j4 |& tee make.nag-7.2.43.log
...
local mdir = pathJoin(mroot,"MPI/nag-7.2.43",("openmpi-"..version))
