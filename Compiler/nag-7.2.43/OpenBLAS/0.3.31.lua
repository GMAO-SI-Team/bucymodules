...
cmake -B build-nag-7.2.43 -S . --install-prefix=/ford1/share/gmao_SIteam/OpenBLAS/nag-7.2.43/0.3.31 |& tee cmake.nag-7.2.43.log
cmake --build build-nag-7.2.43 -j8 |& tee build.nag-7.2.43.log
cmake --install build-nag-7.2.43 |& tee install.nag-7.2.43.log

--]]


local name = "OpenBLAS"
local compiler = "nag-7.2.43"
