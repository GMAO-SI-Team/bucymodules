...
../configure --disable-wrapper-rpath --disable-wrapper-runpath \
    ...
    --prefix=/ford1/share/gmao_SIteam/MPI/openmpi/5.0.4/llvm-flang-2024-08-21 |& tee configure.llvm-flang-2024-08-21.log
...
local mdir = pathJoin(mroot,"MPI/llvm-flang-2024-08-21",("openmpi-"..version))
