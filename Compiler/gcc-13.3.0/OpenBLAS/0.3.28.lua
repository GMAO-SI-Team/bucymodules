...
cmake -B build-gcc-13.3.0 -S . --install-prefix=/ford1/share/gmao_SIteam/OpenBLAS/gcc-13.3.0/0.3.28 |& tee cmake.gcc-13.3.0.log
cmake --build build-gcc-13.3.0 -j8 |& tee build.gcc-13.3.0.log
cmake --install build-gcc-13.3.0 |& tee install.gcc-13.3.0.log

--]]


local name = "OpenBLAS"
local compiler = "gcc-13.3.0"
