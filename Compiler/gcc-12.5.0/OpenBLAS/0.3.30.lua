...
cmake -B build-gcc-12.5.0 -S . --install-prefix=/ford1/share/gmao_SIteam/OpenBLAS/gcc-12.5.0/0.3.30 |& tee cmake.gcc-12.5.0.log
cmake --build build-gcc-12.5.0 -j8 |& tee build.gcc-12.5.0.log
cmake --install build-gcc-12.5.0 |& tee install.gcc-12.5.0.log

--]]


local name = "OpenBLAS"
local compiler = "gcc-12.5.0"
