...
git clone -j 4 --recurse-submodules -b v8.18.0 https://github.com/GEOS-ESM/ESMA-Baselibs.git ESMA-Baselibs-8.18.0/src

This was built using:

ml GEOSpyD/24.11.3-0/3.12 nag/7.2.36 openmpi/5.0.3-GillesNAGPatch

make -j6 install ESMF_COMM=openmpi CONFIG_SETUP='nagfor_7.2.36-openmpi_5.0.3-GillesNAGPatch' |& tee makeinstall.nagfor_7.2.36-openmpi_5.0.3-GillesNAGPatch.log
...
local configsetup = "nagfor_7.2.36-openmpi_5.0.3-GillesNAGPatch"
