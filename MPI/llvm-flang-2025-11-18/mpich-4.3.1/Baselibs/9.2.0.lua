...
git clone -j 4 --recurse-submodules -b v9.2.0 https://github.com/GEOS-ESM/ESMA-Baselibs.git ESMA-Baselibs-9.2.0/src
...
ml GEOSpyD/25.3.1-0/3.13 llvm-flang/2025-11-18 mpich/4.3.1

### Build to HDF4

Next we build up to hdf4:

make -j6 install ESMF_COMM=mpich CONFIG_SETUP='flang_2025-11-18-mpich_4.3.1' ALLDIRS='antlr2 gsl jpeg zlib szlib curl hdf4' |& tee makeinstall.flang_2025-11-18-mpich_4.3.1.uptohdf4.log

### Build HDF5 (will need some hand edits after it crashes)

Then we build hdf5:

make -j6 install ESMF_COMM=mpich CONFIG_SETUP='flang_2025-11-18-mpich_4.3.1' ALLDIRS='antlr2 gsl jpeg zlib szlib curl hdf4 hdf5' |& tee makeinstall.flang_2025-11-18-mpich_4.3.1.hdf5.log
...
make -j6 install ESMF_COMM=mpich CONFIG_SETUP='flang_2025-11-18-mpich_4.3.1' |& tee makeinstall.flang_2025-11-18-mpich_4.3.1.after_hdf5.log
...
local configsetup = "flang_2025-11-18-mpich_4.3.1"
