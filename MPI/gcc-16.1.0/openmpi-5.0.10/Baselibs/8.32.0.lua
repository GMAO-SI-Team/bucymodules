...
ml GEOSpyD/26.3.2-0/3.14 gcc/16.1.0 openmpi/5.0.10

make -j6 install ESMF_COMM=openmpi CONFIG_SETUP='gfortran_16.1.0-openmpi_5.0.10' |& tee makeinstall.gfortran_16.1.0-openmpi_5.0.10.log
...
local configsetup = "gfortran_16.1.0-openmpi_5.0.10"
