...
ml GEOSpyD/24.11.3-0/3.12 gcc/12.5.0 openmpi/5.0.4

make -j6 install ESMF_COMM=openmpi CONFIG_SETUP='gfortran_12.5.0-openmpi_5.0.4' |& tee makeinstall.gfortran_12.5.0-openmpi_5.0.4.log

--]]

family("Baselibs")

local compilername = "gcc-12.5.0"
local mpiname = "openmpi-5.0.4"

local configsetup = "gfortran_12.5.0-openmpi_5.0.4"
