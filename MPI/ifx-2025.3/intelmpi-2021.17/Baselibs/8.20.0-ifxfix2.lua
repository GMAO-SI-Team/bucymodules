...
make -j6 install ESMF_COMM=intelmpi CONFIG_SETUP='ifx_2025.3-intelmpi_2021.17-ifxfix2' |& tee makeinstall.ifx_2025.3-intelmpi_2021.17-ifxfix2.log
...
local configsetup = "ifx_2025.3-intelmpi_2021.17-ifxfix2"
