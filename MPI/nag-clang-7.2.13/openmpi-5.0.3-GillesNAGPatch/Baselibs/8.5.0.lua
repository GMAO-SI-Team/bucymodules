...
ml nag-clang/7.2.13 openmpi/5.0.3-GillesNAGPatch GEOSpyD/24.7.1-0/3.11

make -j6 install ESMF_COMM=openmpi CONFIG_SETUP='nagfor-clang_7.2.13-openmpi_5.0.3-GillesNAGPatch' |& tee makeinstall.nagfor-clang_7.2.13-openmpi_5.0.3-GillesNAGPatch.log
...
local configsetup = "nagfor-clang_7.2.13-openmpi_5.0.3-GillesNAGPatch"
