...
I then updated yafyaml, pflogger and pfunit to the bugfix/ifx-2025.2-support branch

This was built using:

  ml GEOSpyD/24.11.3-0/3.12 ifx/2025.2 intelmpi/2021.16

  make -j6 install ESMF_COMM=intelmpi CONFIG_SETUP='ifx_2025.2-intelmpi_2021.16' |& tee makeinstall.ifx_2025.2-intelmpi_2021.16.log

--]]

family("Baselibs")

local compilername = "ifx-2025.2"
local mpiname = "intelmpi-2021.16"

local configsetup = "ifx_2025.2-intelmpi_2021.16"
