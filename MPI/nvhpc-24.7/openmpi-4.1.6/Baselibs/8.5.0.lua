...
ml nvhpc/24.7 openmpi/4.1.6 GEOSpyD/Min24.4.0-0_py3.11

make -j6 install ESMF_COMM=openmpi CONFIG_SETUP='nvfortran_24.7-openmpi_4.1.6' SYSTEM_ZLIB=YES |& tee makeinstall.nvfortran_24.7-openmpi_4.1.6.log
...
local compilername = "nvhpc-24.7"
local mpiname = "openmpi-4.1.6"

local configsetup = "nvfortran_24.7-openmpi_4.1.6"
