...
This was cloned with:
  ...
  git clone -j 4 --recurse-submodules -b v8.9.0 https://github.com/GEOS-ESM/ESMA-Baselibs.git ESMA-Baselibs-8.9.0/src

This was built using:

  ml gcc/13.3.0 openmpi/5.0.4 GEOSpyD/24.7.1-0/3.11

  make -j6 install ESMF_COMM=openmpi CONFIG_SETUP='gfortran_13.3.0-openmpi_5.0.4' |& tee makeinstall.gfortran_13.3.0-openmpi_5.0.4.log

--]]

family("Baselibs")

local compilername = "gcc-13.3.0"
local mpiname = "openmpi-5.0.4"

local configsetup = "gfortran_13.3.0-openmpi_5.0.4"
