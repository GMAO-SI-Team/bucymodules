...
ml GEOSpyD/25.3.1-0/3.13 llvm-flang/22.1.0 openmpi/5.0.10

### Build to HDF4

Next we build up to hdf4:

make -j6 install ESMF_COMM=openmpi CONFIG_SETUP='flang_22.1.0-openmpi_5.0.10' ALLDIRS='antlr2 gsl jpeg zlib szlib curl hdf4' |& tee makeinstall.flang_22.1.0-openmpi_5.0.10.uptohdf4.log

### Build HDF5 (will need some hand edits after it crashes)

Then we build hdf5:

make -j6 install ESMF_COMM=openmpi CONFIG_SETUP='flang_22.1.0-openmpi_5.0.10' ALLDIRS='antlr2 gsl jpeg zlib szlib curl hdf4 hdf5' |& tee makeinstall.flang_22.1.0-openmpi_5.0.10.hdf5.log
...
make -j6 install ESMF_COMM=openmpi CONFIG_SETUP='flang_22.1.0-openmpi_5.0.10' |& tee makeinstall.flang_22.1.0-openmpi_5.0.10.after_hdf5.log
...
local configsetup = "flang_22.1.0-openmpi_5.0.10"
