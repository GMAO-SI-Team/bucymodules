...
ml GEOSpyD/24.11.3-0/3.12 nvhpc/25.5 openmpi/4.1.6

make -j6 install ESMF_COMM=openmpi CONFIG_SETUP='nvfortran_25.5-openmpi_4.1.6' SYSTEM_ZLIB=YES |& tee makeinstall.nvfortran_25.5-openmpi_4.1.6.log
...
local compilername = "nvhpc-25.5"
local mpiname = "openmpi-4.1.6"

local configsetup = "nvfortran_25.5-openmpi_4.1.6"
