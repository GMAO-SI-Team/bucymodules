...
ml GEOSpyD/26.3.2-0/3.14 gcc/14.4.0 openmpi/5.0.4

make -j6 install ESMF_COMM=openmpi CONFIG_SETUP='gfortran_14.4.0-openmpi_5.0.4' |& tee makeinstall.gfortran_14.4.0-openmpi_5.0.4.log
...
local configsetup = "gfortran_14.4.0-openmpi_5.0.4"
