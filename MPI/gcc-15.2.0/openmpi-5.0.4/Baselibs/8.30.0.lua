...
ml GEOSpyD/25.3.1-0/3.13 gcc/15.2.0 openmpi/5.0.4

make -j6 install ESMF_COMM=openmpi CONFIG_SETUP='gfortran_15.2.0-openmpi_5.0.4' |& tee makeinstall.gfortran_15.2.0-openmpi_5.0.4.log
...
local configsetup = "gfortran_15.2.0-openmpi_5.0.4"
