...
git clone -j 4 --recurse-submodules -b v8.16.0 https://github.com/GEOS-ESM/ESMA-Baselibs.git ESMA-Baselibs-8.16.0-ESMFdevelop/src
cd ESMA-Baselibs-8.16.0-ESMFdevelop/src/esmf
